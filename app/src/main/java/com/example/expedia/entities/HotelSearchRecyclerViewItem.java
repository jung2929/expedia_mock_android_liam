...
public class HotelSearchRecyclerViewItem {
    private Drawable hotel_search_image;
    ...
    public HotelSearchRecyclerViewItem(Drawable hotel_search_image, String hotel_search_percent, String hotel_search_name,
                                       String hotel_search_loc_detail, String hotel_search_rate, String hotel_search_price) {
    ...
    public Drawable getHotel_search_image() {
        return hotel_search_image;
    }

    public void setHotel_search_image(Drawable hotel_search_image) {
        this.hotel_search_image = hotel_search_image;
    }
